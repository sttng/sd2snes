...
;-
;-  This is overkill, but puts practically everything to a known state.
;-  It is also sloppy (one example: Mode 7 regs are set to a known state, 
;-    but not a useful one.  And of course I haven't bothered fixing
;-    any of this.)
;------------------------------------------------------------------------


;----------------------------------------------------------------------------
; InitializeSNES -- sets pratically everything to a known state
;----------------------------------------------------------------------------
