...
;-
;-  text functions to give "printf" like capability
;-  supports text color
;------------------------------------------------------------------------

;String Functions RAM locations
.DEFINE Cursor	$F0         ;Holds 16-bit position on screen
.DEFINE TxtColor  $F2		;Holds 8-bit value for high byte of tilemap

;Obviously these depend on the palette, and tiles
.DEFINE TxtWhite	$20	; actually color 0*4+3 of 256 color pallete
.DEFINE TxtBlue	$24	; actually color 1*4+3 of 256 color pallete
.DEFINE TxtGreen	$28	; actually color 2*4+3 of 256 color pallete
.DEFINE TxtRed	$2C	; actually colot 3*4+3 of 256 color pallete
...
_cn:  BNE _ct
	...
	CLC
	ADC #$0040			;move to the next line
	AND #$FFC0
