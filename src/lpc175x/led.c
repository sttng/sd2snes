...
void led_pwm() {
  GPIO_MODE_AF(LED_READY_REG, LED_READY_BIT, LED_READY_PWM_AFNUM);
  GPIO_MODE_AF(LED_READ_REG, LED_READ_BIT, LED_READ_PWM_AFNUM);
  GPIO_MODE_AF(LED_WRITE_REG, LED_WRITE_BIT, LED_WRITE_PWM_AFNUM);
