...
//      firmware uses (verified in lockstep against MesenCE's ArmV3Cpu).
...
//
// Edge-case policy follows MesenCE where the architecture leaves room
    ...
    case (st)
      ...
      S_OPS: begin
        if (c_mul) begin
          ...
          // never select a shift (R15 reads as PC+8, as in MesenCE)
          if (b_I) begin
            opB   <= {24'd0, ir[7:0]};
            shout <= {24'd0, ir[7:0]};
      ...
      S_WB: begin
        ...
        // simply updated (MesenCE behaviour; architecturally unpredictable)
