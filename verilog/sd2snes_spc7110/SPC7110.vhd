...
architecture rtl of SPC7110 is
	...
	-- Step 18: DEC gets its own slow clock (CLK / 6 = 16 MHz).
	-- The MiSTer DEC RTL uses both edges of the clock; at 96 MHz that's a 5.2 ns
	-- half-period budget which cannot hold the 21.5 ns combinational path from
	-- OUTPUT to IN_LOW. At 16 MHz the half-period is 31.25 ns and the path closes
	-- with ~10 ns of margin. SPC7110_DEC.vhd itself is unchanged.
