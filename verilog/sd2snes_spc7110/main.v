...
assign SNES_DATA = (r213f_enable & ~SNES_PARD & ~r213f_forceread) ? r213fr
              ...
              :(spc7110_enable & (~SPC7110_RAM_CE | ~SPC7110_ROM_CE | FSM_DMA_Transferring | spc7110_reg_enable)) ? SPC7110_SNES_DATA_OUT
...
assign ROM_ADDR22 = (SD_DMA_TO_ROM) ? MCU_ADDR[1]
            : SPC7110_ROM_IS_DROM ? SPC7110_ROM_ADDR[0] // override MCU_HIT
            : MCU_HIT ? ROM_ADDRr[1]
...
assign ROM_ADDR  = (SD_DMA_TO_ROM) ? MCU_ADDR[23:2]
            : SPC7110_ROM_IS_DROM ? ({1'b0, SPC7110_ROM_ADDR[21:1] & ROM_MASK[22:2]}) // Step 17: override MCU_HIT
...
assign ROM_ADDR0 = (SD_DMA_TO_ROM) ? MCU_ADDR[0]
            : SPC7110_ROM_IS_DROM ? 1'b0 // Step 17: 16-bit word read; byte lane muxed downstream
            : MCU_HIT ? ROM_ADDRr[0]
...
assign ROM_BHE = ((spc7110_enable & ~SPC7110_ROM_CE & ~MCU_HIT) | SPC7110_ROM_IS_DROM)?1'b0:ROM_ADDR0;
// '0' when accessing low byte
assign ROM_BLE = ((spc7110_enable & ~SPC7110_ROM_CE & ~MCU_HIT) | SPC7110_ROM_IS_DROM)?1'b0:!ROM_ADDR0;
