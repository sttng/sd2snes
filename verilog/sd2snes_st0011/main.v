...
wire [15:0] dsp_feat;
`ifndef MK2_DEBUG
// DSP program fetch arbiter nets. Declared ahead of the upd77c25
// instantiation below, which connects them: using a name before its
// declaration creates an implicit net, and the later explicit
// declaration is then an illegal redeclaration under ISE.
reg RQ_DSP_RDYr;
...
upd77c25 snes_dspx (
  ...
  .ss_halt(1'b0),   // scan port disabled -- see above
