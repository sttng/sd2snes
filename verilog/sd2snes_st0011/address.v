...
assign dspx_enable =
  ...
  ?((MAPPER_DEC[3'b001])
    ...
    :1'b0)
  :featurebits[FEAT_ST0010]
  // ST011: DR at $60:0000, SR at $60:0001, mirrored at $E0.
  // Window is $0000-$0FFF, matching the hardware decode -- NOT the full
  // $0000-$7FFF this used to accept. Reads and writes here have side effects (a DR access
...
// uPD96050: always, at banks $68-$6F/$E8-$EF (its data RAM is exposed here).
